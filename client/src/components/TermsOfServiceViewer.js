...
const TermsOfServiceViewer = ({ isOpen, onClose }) => {
  ...
  // Derive a human-readable "Last updated" date from today's date so the
  // document always shows the current date rather than a placeholder.
...
By using StudyFocus, you agree to these terms. We've kept them simple and fair.

## 1. What StudyFocus Is

StudyFocus is a study and productivity platform designed to help users focus, track study activity, and collaborate with friends.

We may add, remove, or change features over time as the app evolves.

## 2. Using the App

You must use StudyFocus in a lawful and respectful way.

Don't misuse the app, attempt to break it, or interfere with other users.

You're responsible for anything you do while logged into your account.

## 3. Accounts

You're responsible for keeping your account secure.

If something looks wrong with your account, let us know.

We can suspend or remove accounts that seriously misuse the platform.

## 4. Content You Create

Messages, goals, study data, and other content you create belong to you.

By using StudyFocus, you allow us to store and display this content so the app can function.

We don't claim ownership over your content.

## 5. Availability

StudyFocus is provided "as is".

We do our best to keep it running smoothly, but it may occasionally be unavailable due to updates, bugs, or maintenance.

## 6. Changes to These Terms

These terms may change as StudyFocus grows.

If we make major changes, we'll try to make them clear.

## 7. Contact

If you have questions or concerns, contact us through the app or our official channels.`;
    ...
    >
      <div className="user-guide-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="user-guide-header">
          <h2 className="user-guide-title">Terms of Service</h2>
          <button 
...
export default TermsOfServiceViewer;
